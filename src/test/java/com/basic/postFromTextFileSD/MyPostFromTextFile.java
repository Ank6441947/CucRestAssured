...
public class MyPostFromTextFile {
	...
	public void user_hit_the_post_request_with_json_data() throws IOException{
		...
		File file = new File("D:\\selenium\\workspace\\CucRestAssured\\src\\test\\java\\com\\basic\\postFromTextFileSD\\user.json");
	    //String content = null;
		
		resp = RestAssured.given().contentType(ContentType.JSON).relaxedHTTPSValidation().
